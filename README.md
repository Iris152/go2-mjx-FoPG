...
- forward residual reward includes lateral drift and yaw-rate penalties
...
- additional forward residual penalties: `lateral_velocity=-1.0`, `yaw_rate=-0.5`
...
- internal servo: `servo_kp=50.0`, `servo_kd=0.5`
